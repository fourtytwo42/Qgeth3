...
func (obj *Header) EncodeRLP(_w io.Writer) error {
	...
	_tmp6 := obj.QBits != nil
	_tmp7 := obj.TCount != nil
	_tmp8 := obj.LUsed != nil
	_tmp9 := obj.QNonce != (QuantumNonce{})
	_tmp10 := len(obj.QOutcome) > 0
	_tmp11 := len(obj.QProof) > 0
	...
	if _tmp6 || _tmp7 || _tmp8 || _tmp9 || _tmp10 || _tmp11 {
		if obj.QBits == nil {
			...
			w.WriteUint64(uint64((*obj.QBits)))
		}
	}
	if _tmp7 || _tmp8 || _tmp9 || _tmp10 || _tmp11 {
		if obj.TCount == nil {
			...
			w.WriteUint64(uint64((*obj.TCount)))
		}
	}
	if _tmp8 || _tmp9 || _tmp10 || _tmp11 {
		if obj.LUsed == nil {
			...
			w.WriteUint64(uint64((*obj.LUsed)))
		}
	}
	if _tmp9 || _tmp10 || _tmp11 {
		w.WriteBytes(obj.QNonce[:])
	}
	if _tmp10 || _tmp11 {
		w.WriteBytes(obj.QOutcome)
	}
	if _tmp11 {
		w.WriteBytes(obj.QProof)
	}
	w.ListEnd(_tmp0)
	return w.Flush()
}
