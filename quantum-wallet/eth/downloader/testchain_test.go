...
func (tc *testChain) generate(n int, seed byte, parent *types.Block, heavy bool) {
	blocks, _ := core.GenerateChain(testGspec.Config, parent, qmpow.NewFaker(), testDB, n, func(i int, block *core.BlockGen) {
...
func newTestBlockchain(blocks []*types.Block) *core.BlockChain {
	...
	tbc.gen.Do(func() {
		...
		chain, err := core.NewBlockChain(rawdb.NewMemoryDatabase(), nil, testGspec, nil, qmpow.NewFaker(), vm.Config{}, nil, nil)
		if err != nil {
			panic(err)
		}
